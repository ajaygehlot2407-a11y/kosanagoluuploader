...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8226827288:AAEv9ahxG84uqOcar-okz7qVWqOTVcZADyg")

CREDIT = os.environ.get("CREDIT", "NOT YOUR TYPE")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "CpprivateApi")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://techaj:sxwuVd4nwOKk5dB8@cluster0.0tue9sm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # Add your own atlas db
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "1168219996"))
